...
<div class="navbar navbar-default" role="navigation">
    <div class="navbar-header">
        <a class="navbar-brand" href="${pageContext.request.contextPath}/user/index">电影资源网</a>
    </div>
    <div class="navbar-collapse collapse">
        ...
        <ul class="nav navbar-nav">
            ...
            <li><a href="#" class="dropup"><i class="fa fa-list"></i>菜单</a>
                <ul class="dropdown-menu">
                    ...
                    <li class="divider"></li>
                    <li class="dropdown-header">导航头</li>
                    <li><a href="#">分类<span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <c:forEach items="${classes}" var="cs">
                                <li>
                                    <a href="${pageContext.request.contextPath}/movieClass/clist.do?classMId=${cs.mId}">${cs.mName}</a>
                                </li>
                            </c:forEach>
                        </ul>
                    </li>
        ...
        <form class="navbar-form navbar-left" method="post" action="${pageContext.request.contextPath}/movie/findOne.do" role="search">
...
<div id="page-content" class="index-page">
    <div id="container">
        ...
        <c:forEach items="${mlist}" var="video">
            <div class="item">
                <a class="example-image-link" href="${pageContext.request.contextPath}/movie/info.do?vid=${video.vId}&cut=${video.vCount}">
                    <img class="example-image" src="${video.vImg}" alt=""/></a>
                <div class="content-item">
                    <span class="time"><a class="btn btn-3">${video.mName}</a> </span>
                    <h3 class="title-item">电影名：<a href="#">${video.vName}</a></h3>
                    <p class="info">${video.vInfo}</p>
                    <ul class="list-inline">
                        <li><a href="#">浏览量:<i class="fa fa-eye"></i> ${video.vCount}</a></li>
