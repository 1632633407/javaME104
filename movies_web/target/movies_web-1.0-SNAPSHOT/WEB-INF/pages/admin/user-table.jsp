                                ...
                                <table class="table">
                                    ...
                                    <c:forEach items="${users}" var="user" begin="1">
                                        <tr>
                                            ...
                                            <td>${user.uEmail}</td>
                                            <td>${user.uSex}</td>
                                            <td>${user.uLoginTime}</td>
                                            <td>
                                                <c:if test="${user.uStauts=='1'}">
                                                    否
                                                </c:if>
                                                <c:if test="${user.uStauts=='2'}">
                                                    是
                                                </c:if>
                                            </td>
                                            <td>
                                                <a href="${pageContext.request.contextPath}/admin/trVip.do?uName=${user.uName}&uStauts=${user.uStauts}">切换高级用户</a>
                                                <a href="${pageContext.request.contextPath}/admin/delUser.do?uName=${user.uName}">删除</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
