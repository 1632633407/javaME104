    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            <div class="col-md-6 col-4 align-self-center">
                <a href="${pageContext.request.contextPath}/admin/insClassMain.do"
                   class="btn pull-right btn-success">添加分类</a>
            </div>
            <!-- ============================================================== -->
                                ...
                                <table class="table">
                                    ...
                                    <c:forEach items="${classes}" var="mclass">
                                        <tr>
                                            <td>${mclass.id}</td>
                                            <td>${mclass.mName}</td>
                                            <td><a href="${pageContext.request.contextPath}/admin/delClass.do?mId=${mclass.mId}">删除</a></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
